...
**用户偏好（2026.07.31）**：用户明确表示**不做Q版/chibi风格**，因为"很容易失真"。当用户提供真实人物照片时，**默认推荐非chibi路线**，除非用户明确要求Q版风格。
...
**用户偏好**：当桌宠素材是真实人物照片（如女朋友、家人）时，用户可能明确拒绝Q版/chibi化，因为"很容易失真"——AI重绘后不像本人。此时必须提供非chibi路线，而不是默认推chibi工作流。
